...
public class BrowseProductsJPanel extends javax.swing.JPanel {
    ...
    private void btnModifyQuantityActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyQuantityActionPerformed
        ...
        if(selectedRowIndex<0){
            JOptionPane.showMessageDialog(null, "Please select order item first", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this, "Please select price and quantity first");
            return;
    ...
    private void btnViewOrderItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewOrderItemActionPerformed
        int selectedRowIndex=tblCart.getSelectedRow();
        if(selectedRowIndex<0){
            JOptionPane.showMessageDialog(null, "Please select an item first", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
        OrderItem item = (OrderItem) tblCart.getValueAt(selectedRowIndex, 0);
        ViewOrderItemDetailJPanel vop = new ViewOrderItemDetailJPanel(userProcessContainer, item);
        userProcessContainer.add("ViewOrderItemDetailJPanel", vop);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        layout.next(userProcessContainer);
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if(salesPrice>product.getPrice()){
            JOptionPane.showMessageDialog(this, "Price should not be more than it is set in the price", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
