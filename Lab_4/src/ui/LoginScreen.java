...
//        JPanel selectedPanel_1 = (JPanel) cmbRoles.getSelectedItem();
//        if (selectedPanel_1.getClass() == SupplierWorkAreaJPanel.class) {
//            JOptionPane.showMessageDialog(this, "Please select a supplier to login under supplier role");
//            return;
//        } else {
//            selectedPanel_1 = new SupplierWorkAreaJPanel(mainWorkArea, selectedSupplier);
//        }
        
        if (selectedPanel.getClass() == AdminWorkAreaJPanel.class) {
            selectedPanel = new AdminWorkAreaJPanel(mainWorkArea,supplierDirectory );
        } else if (selectedPanel.getClass() == SupplierWorkAreaJPanel.class) {
