...
public class SearchForProductJPanel extends javax.swing.JPanel {
   ...
   Product product;
    ...
    public SearchForProductJPanel(JPanel workArea, Supplier supplier, ProductCatalog catalog) {
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        Product product = supplier.getProductCatalog().searchProduct(Integer.parseInt(idField.getText()));
        ViewProductDetailJPanel viewProductDetailsPanel = new ViewProductDetailJPanel(workArea, product);
        workArea.add("ViewProductDetailJPanel",viewProductDetailsPanel);
